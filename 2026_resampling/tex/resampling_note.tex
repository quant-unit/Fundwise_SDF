...
tractability of inference make the dollar NPV moment our primary
specification: it delivers a unified pricing restriction across
\(\mathcal V^S\) and \(\mathcal V^U\) without introducing long-horizon NAV
discounting through the back door. We additionally report two variants as
robustness checks:
(a)~a scale-normalized NPV, \(m^{\mathrm{NPV}}_{n,j}/\sum_{i\in C_{n,j}}K_i\)
where \(K_i\) is committed capital, which preserves linearity while
neutralizing the large-fund tilt; and
