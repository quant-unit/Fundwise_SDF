...
\section*{Online Appendix to Identification and Stability of SDF Estimators for Pooled, Non-traded Cash Flow}


Appendix~\ref{sec:appendix_notation} provides a comprehensive summary of the notation.
...
This appendix provides a comprehensive summary of the notation used throughout the paper. Table~\ref{tab:notation_asset_pricing} summarizes the key variables for the deal-level data generation process and the pooled cash-flow pricing framework. Table~\ref{tab:notation_estimator} summarizes the notation for the generalized Least-Mean-Distance estimator and its increasing-domain asymptotic benchmark.
