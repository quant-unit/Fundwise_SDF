...
\abstract{
	This paper proposes an improved stochastic discount factor estimation methodology suited for fund-level cash flows of private equity funds and other pooled, non-traded cash flow streams.
...
There we show in our example that controlling for the optimal size of $\mathcal{T}$ can control the small-sample bias and variance of the original \cite{DLP12} estimator that just discounts all cash flows to the fund inception date.
