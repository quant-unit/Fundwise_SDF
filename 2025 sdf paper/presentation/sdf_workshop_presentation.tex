...
\begin{itemize}
  ...
  \item Plan: naive benchmark first, then semiparametric SDF estimation.
\end{itemize}
...
\begin{frame}{Agenda}
\begin{enumerate}
  \item Motivation via NAV-return autocorrelation and Dimson beta (6 min)
  \item Estimator and inference framework (7 min)
  \item Simulation evidence on bias-variance tradeoff (9 min)
  \item Empirical PE results and practical implications (6 min)
  \item Takeaways and comparison to naive benchmark (2 min)
\end{enumerate}
\end{frame}
