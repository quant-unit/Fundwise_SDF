...
\begin{enumerate}
	...
	Componentwise $L_2$ boosting often incorporates a shrinkage parameter, which controls the contribution of each weak learner to the ensemble (in our case 0.33). 
